...
class Log:
    def log(self, text:str, color:str=None, styles:List[str]=[], console:object|None=None):
        log(text, color, styles, console)
    #================================#
    def error(self, text:str, console:object|None=None):
        log_error(text, console)
    #================================#
    def success(self, text:str, console:object|None=None):
        log_success(text, console)
    #================================#
    def list(self, list:List, color:str=None, styles:List[str]=[], list_name:str=None, list_color:str=None, list_styles:List[str]=[], console:object=None):
        log_list(list, color, styles, list_name, list_color, list_styles, console)
    #================================#
    def dict(self, dict:Dict,
                key_color:str=None, value_color:str=None,
                styles:List[str]=[],
                dict_name=None, name_color:str=None, name_styles:List[str]=None,
                console=None):
        log_dict(
            dict, key_color, value_color, styles,
            dict_name, name_color, name_styles, console)
